        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-5 mb-4">
                    ...
                    <hr
                        style="border-top: 3px solid rgb(226 232 240);border-radius:.5rem"
                    />
                    <p>
                        Toko Online Shopping/Store Terpercaya di Indonesia. Jual
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-4 mb-3">
                            <div class="card h-100 border-0 rounded shadow">
                                <div class="card-body p-2 text-center">
                                    <img
                                        src="@/assets/payment/indomaret-logo.png"
                                        style="width: 60px;"
                                    />
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 col-4 mb-3">
                            <div class="card h-100 border-0 rounded shadow">
                                <div class="card-body p-2 text-center">
                                    <img
                                        src="@/assets/payment/atm-bersama.jpg"
                                        style="width: 40px;"
                                    />
                                </div>
                            </div>
                ...
                <div class="col-md-4 mb-4">
                    ...
                    <p>
                        <i class="fa fa-map-marker"></i> Desa Gedang Alas, RT/RW
                        : 008/002, Kecamatan Gajah, Kabupaten Demak, Jawa
                        Tengah, 58591
                    </p>
                </div>
            </div>
            <div class="row text-center mt-3 pb-3">
                <div class="col-md-12">
                    <hr />
                    &copy; <strong>Online Shop</strong> 2020 • Hak Cipta
                    Dilindungi
                </div>
            </div>
        </div>
