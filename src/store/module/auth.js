...
const auth = {
    ...
    mutations: {
        ...
        // fungsi logout
        AUTH_LOGOUT(state) {
            state.token = ''; //set state token ke empty (kosong)
            state.user = {}; //set state data user ke empty array (array kosong)
        },
    },
                    ...
                    .then((response) => {
                        ...
                        Api.get('/cart').then((response) => {
                            ...
                            commit('cart/GET_CART', response.data.cart, {
                                root: true,
                            }); // <-- kita tambahkan root menjadi true, karena beda modulue
                        });
